$(document).ready(function(){
	...
	$("input[name='add_commodity_enter']").click(function(){
		if($("input[name='state']:checked").length > 0){
			...
			commodity_str += "<td>"+$("#brand_"+id).html()+"</td>";
			commodity_str += "<td>"+$("#commodity_serial_number_"+id).html()+"</td>";
			commodity_str += "<td>"+$("#commodity_color_"+id).html()+"</td>";
			commodity_str += "<td>"+$("#commodity_size_"+id).html()+"</td>";
			commodity_str += "<td style='width:65px;padding:0px;'><input type='hidden' name='commodity_id[]' value='"+id+"' /><input type='text' class='input_6' id='purchase_price_"+id+"' name='purchase_price[]' /></td>";
			commodity_str += "<td style='width:65px;padding:0px;'><input type='text' class='input_6' id='num_"+id+"' name='num[]' /></td>";
			commodity_str += "<td name='total' id='total_"+id+"' align='right'>&nbsp;</td>";
